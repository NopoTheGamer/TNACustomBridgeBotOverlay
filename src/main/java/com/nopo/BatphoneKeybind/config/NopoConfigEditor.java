...
public class NopoConfigEditor extends GuiElement {
    ...
    public void render() {
        ...
        TextRenderUtils.drawStringCenteredScaledMaxWidth( "Mod by " + EnumChatFormatting.AQUA + "Nopo" + EnumChatFormatting.GRAY + ", Tweaked By " + EnumChatFormatting.GOLD + "JimmyWasHere" + EnumChatFormatting.GRAY + ", Config by " + EnumChatFormatting.DARK_PURPLE + "Moulberry",
